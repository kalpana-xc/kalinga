...
function Bullet({ children }) {
  return (
    <li className="flex gap-3">
      <span className="mt-1 inline-flex h-5 w-5 items-center justify-center rounded bg-[var(--dark-skin)] text-[var(--foreground)]">
        <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor">
          <path d="M14 5l-1.41 1.41L16.17 10H5v2h11.17l-3.58 3.59L14 17l7-7z" />
        </svg>
      </span>
      <p className="text-sm leading-7 text-[var(--light-text-gray)]">{children}</p>
    </li>
  );
}
  ...
  return (
    <section className="w-full py-14">
      <div className="mx-auto w-full max-w-5xl px-4">
        <h2 className="text-center font-stix text-3xl font-bold md:text-4xl text-[var(--foreground)]">
