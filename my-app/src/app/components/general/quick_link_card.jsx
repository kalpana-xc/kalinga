...
const QuickLinkCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className="font-semibold text-lg sm:text-xl mb-2 pb-2 border-b border-gray-700 text-[var(--foreground)]">
        {title}
      </h3>

      {/* Description */}
      <p className="text-gray-600 text-sm mb-4 sm:mb-6 flex-grow font-plus-jakarta-sans">
        {description}
      </p>
